...
function Definitions()
	...
	{
		"StructureForce",
		"Ground_Ion_Cannon | Ground_Empire_Hypervelocity_Gun | Ground_Magnepulse_Cannon | Ground_Gravity_Generator | Empire_Golan_One | Rebel_Golan_One | Empire_Golan_Two | Rebel_Golan_Two | Empire_Golan_Three | Rebel_Golan_Three= 1"
	}
	}
