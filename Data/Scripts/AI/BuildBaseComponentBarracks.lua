...
function Definitions()
	...
	{
		"BaseForce",
		"E_Ground_Barracks | R_Ground_Barracks | Empire_MoffPalace | Rebel_Outpost | Rebel_Capital | Empire_Capital | Ground_Droid_Works |
		ER_Ground_Barracks | GM_Ground_Barracks | Eriadu_MoffPalace | Maldrood_MoffPalace | Maldrood_Capital | Eriadu_Capital = 1"
	}
	}
