...
function libLayerZ.setLayerZ(gameObject)
    ...
    elseif gameObject.Is_Category("Super") then
        layer = "SUPER"
	elseif gameObject.Is_Category("SuperCapital") then
        layer = "SUPER"
    end
    local layerMarkerTable = {
        ["CORVETTE"] = {
        "CORVETTE_00", "CORVETTE_01", "CORVETTE_02", "CORVETTE_03", "CORVETTE_04", "CORVETTE_05", "CORVETTE_06", "CORVETTE_07", "CORVETTE_08", "CORVETTE_09", "CORVETTE_10", "CORVETTE_11", "CORVETTE_12", "CORVETTE_13"
        },
        ["FRIGATE"] = {
